export default function Home() {
  return (
    ...
    <div className="relative w-full max-w-[1600px] min-h-[85vh] rounded-[50px] overflow-hidden shadow-2xl flex flex-col">
      ...
      {/* Le Contenu */}
      <div className="relative z-10 p-8 md:p-16 text-white flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 flex-1 items-stretch">
          ...
          <div className="flex flex-col">
              ...
              <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                      <input type="text" placeholder="Nom" className="p-3 rounded-full text-black bg-white outline-none px-6 w-full" />
                      <input type="text" placeholder="Prénom" className="p-3 rounded-full text-black bg-white outline-none px-6 w-full"/>
                  </div>
              ...
              <div className="p-6 mt-auto">
                  ...
                  <div className="flex gap-3 items-center flex-wrap">
                      ...
                      <button className="bg-[#3F1486] text-white p-3 py-2 text-lg rounded-full hover:bg-opacity-90 transition-all font-bold uppercase leading-tight flex items-center justify-center text-center">
                        AJOUTER<br/>DISPO
                      </button>
                  </div>
              </div>
          ...
          <div className="flex flex-col">
              ...
              <div className="mt-auto flex justify-end p-6">
                  <button className="bg-[#FBAD18] text-white w-full md:w-[350px] py-3 text-2xl rounded-full hover:bg-opacity-90 transition-all font-black uppercase tracking-widest shadow-lg">
                    Envoyer
                  </button>
              </div>
          </div>
